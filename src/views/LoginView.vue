    ...
    <div class="w-full max-w-sm">
      ...
      <div class="bg-navy-800 rounded-2xl border border-navy-700 p-6 shadow-2xl">
        ...
        <div class="flex flex-col gap-2 mb-4">
          ...
          <button
            type="button"
            class="flex items-center justify-center gap-3 w-full py-2.5 rounded-lg bg-[#1877F2] hover:bg-[#1565d8] text-white font-semibold text-sm transition-all"
            @click="auth.loginWithOAuth('facebook')"
          >
            <svg class="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97h-1.513c-1.491 0-1.956.93-1.956 1.887v2.267h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"/></svg>
